                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.dishes.update', $dish->id) }}" method="post"
                            ...
                            <div class="row">
                                ...
                                <!-- Portata -->
                                <div class="col-12 mb-3 col-md-6">
                                    <label class="form-label" for="course"><i class="bi bi-card-list me-2"></i>Portata <span class="text-danger">*</span></label>
                                ...
                                <!-- Prezzo -->
                                <div class="col-12 mb-3 col-md-6">
                                    <label class="form-label" for="price"><i class="bi bi-currency-euro me-2"></i>Prezzo <span class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                            ...
                                            <div>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="visible" id="visible_yes" value="1" {{ old('visible', $dish->visible) ? 'checked' : '' }} required>
                                                        <label class="form-check-label" for="visible_yes">Sì</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="visible" id="visible_no" value="0" {{ old('visible', $dish->visible) ? '' : 'checked' }} required>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div>
                                                ...
                                                <div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="vegetarian" id="vegetarian_yes" value="1" {{ old('vegetarian', $dish->vegetarian) ? 'checked' : '' }} required>
                                                        <label class="form-check-label" for="vegetarian_yes">Sì</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="vegetarian" id="vegetarian_no" value="0" {{ old('vegetarian', $dish->vegetarian) ? '' : 'checked' }} required>
                                ...
                                <!-- Descrizione -->
                                <div class="col-12">
                                    <label class="form-label" for="description"><i class="bi bi-chat-square-text me-2"></i> Descrizione <span class="text-danger">*</span></label>
                                    <textarea name="description" id="description" rows="5"
                                        class="form-control form-control-sm @error('description') is-invalid @enderror" placeholder="Descrizione" required>{{ old('description', $dish->description) }}</textarea>
                                    @error('description')
                                        <div class="text-danger"> {{ $message }} </div>
                                    @enderror
                                </div>
